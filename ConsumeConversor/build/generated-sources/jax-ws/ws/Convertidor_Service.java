 ...
 * 
 */
@WebServiceClient(name = "Convertidor", targetNamespace = "http://ws/", wsdlLocation = "http://desktop-v9egkm5:8080/SWConversor/Convertidor?wsdl")
    ...
    extends Service
{
    ...
    private final static QName CONVERTIDOR_QNAME = new QName("http://ws/", "Convertidor");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://desktop-v9egkm5:8080/SWConversor/Convertidor?wsdl");
    ...
    public Convertidor getConvertidorPort() {
        return super.getPort(new QName("http://ws/", "ConvertidorPort"), Convertidor.class);
    }
    ...
    public Convertidor getConvertidorPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://ws/", "ConvertidorPort"), Convertidor.class, features);
    }
